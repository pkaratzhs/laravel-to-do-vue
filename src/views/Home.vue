...
<div class="container">
    ...
    <BouncyLoader class="align-middle mt-5" v-if="lists===null"/>
    <div class="flex-row d-flex flex-wrap mt-5">
        <div class="card m-2" style="width: 18rem;" v-for="(list,index) in lists" :key="index">
        <div class="card-body">
